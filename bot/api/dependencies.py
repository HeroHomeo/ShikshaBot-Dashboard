...
_bot_instance: Optional["shikshabot"] = None
...
def set_bot(bot_instance: "shikshabot"):
    """
    Sets the global bot instance. 
    This should be called in ShikshaBot.py during startup.
    """
    global _bot_instance
    _bot_instance = bot_instance

def get_bot() -> "shikshabot":
    """
    FastAPI dependency to retrieve the Discord bot instance.
    Usage: bot: shikshabot = Depends(get_bot)
    """
